 ...
 * under the License.
 */
namespace Emmetltd\AliyunCore\Profile;

use Emmetltd\AliyunCore\Auth\Credential;
use Emmetltd\AliyunCore\Auth\EcsRamRoleCredential;
use Emmetltd\AliyunCore\Auth\RamRoleArnCredential;
use Emmetltd\AliyunCore\Auth\ShaHmac1Signer;
use Emmetltd\AliyunCore\Regions\Endpoint;
use Emmetltd\AliyunCore\Regions\EndpointProvider;
use Emmetltd\AliyunCore\Regions\LocationService;
use Emmetltd\AliyunCore\Regions\ProductDomain;
...
class DefaultProfile implements IClientProfile
{
    ...
    {
        $endpoint_filename = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'Regions' . DIRECTORY_SEPARATOR . "endpoints.xml";
