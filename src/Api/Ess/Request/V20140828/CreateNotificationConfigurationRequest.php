...
class CreateNotificationConfigurationRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Ess", "2014-08-28", "CreateNotificationConfiguration", "ess", "openAPI");
		$this->setMethod("POST");
	}
