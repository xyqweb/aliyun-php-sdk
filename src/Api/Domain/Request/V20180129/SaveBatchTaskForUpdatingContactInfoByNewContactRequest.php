...
class SaveBatchTaskForUpdatingContactInfoByNewContactRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Domain", "2018-01-29", "SaveBatchTaskForUpdatingContactInfoByNewContact");
		$this->setMethod("POST");
	}
