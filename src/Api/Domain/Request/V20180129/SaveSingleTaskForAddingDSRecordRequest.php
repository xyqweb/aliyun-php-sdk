...
class SaveSingleTaskForAddingDSRecordRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Domain", "2018-01-29", "SaveSingleTaskForAddingDSRecord");
		$this->setMethod("POST");
	}
