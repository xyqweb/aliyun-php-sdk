...
class ModifyReadonlyInstanceDelayReplicationTimeRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Rds", "2014-08-15", "ModifyReadonlyInstanceDelayReplicationTime", "rds", "openAPI");
		$this->setMethod("POST");
	}

	private  $resourceOwnerId;

	private  $readSQLReplicationTime;
	...
	public function getReadSQLReplicationTime() {
