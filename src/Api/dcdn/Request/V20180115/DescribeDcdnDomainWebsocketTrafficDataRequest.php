 ...
 * under the License.
 */
namespace Emmetltd\AliyunCore\Api\dcdn\Request\V20180115;

class DescribeDcdnDomainWebsocketTrafficDataRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("dcdn", "2018-01-15", "DescribeDcdnDomainWebsocketTrafficData", "dcdn", "openAPI");
		$this->setMethod("POST");
	}
