...
class DescribeDcdnDomainQpsDataRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("dcdn", "2018-01-15", "DescribeDcdnDomainQpsData", "dcdn", "openAPI");
		$this->setMethod("POST");
	}
