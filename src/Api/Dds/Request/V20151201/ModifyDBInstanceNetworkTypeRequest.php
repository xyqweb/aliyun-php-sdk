...
class ModifyDBInstanceNetworkTypeRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Dds", "2015-12-01", "ModifyDBInstanceNetworkType", "dds", "openAPI");
		$this->setMethod("POST");
	}
