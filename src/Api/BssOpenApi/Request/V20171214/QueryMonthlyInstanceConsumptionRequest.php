...
class QueryMonthlyInstanceConsumptionRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("BssOpenApi", "2017-12-14", "QueryMonthlyInstanceConsumption");
		$this->setMethod("POST");
	}
