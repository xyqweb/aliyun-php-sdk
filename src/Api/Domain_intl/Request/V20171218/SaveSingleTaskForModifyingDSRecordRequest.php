...
class SaveSingleTaskForModifyingDSRecordRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Domain-intl", "2017-12-18", "SaveSingleTaskForModifyingDSRecord", "domain", "openAPI");
		$this->setMethod("POST");
	}
