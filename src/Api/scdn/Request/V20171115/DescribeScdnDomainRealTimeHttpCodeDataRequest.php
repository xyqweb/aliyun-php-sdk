...
class DescribeScdnDomainRealTimeHttpCodeDataRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("scdn", "2017-11-15", "DescribeScdnDomainRealTimeHttpCodeData", "scdn", "openAPI");
		$this->setMethod("POST");
	}
