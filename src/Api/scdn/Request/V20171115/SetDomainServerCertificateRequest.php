...
class SetDomainServerCertificateRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("scdn", "2017-11-15", "SetDomainServerCertificate", "scdn", "openAPI");
		$this->setMethod("POST");
	}
