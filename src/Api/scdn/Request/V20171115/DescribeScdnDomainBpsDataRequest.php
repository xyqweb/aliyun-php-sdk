...
class DescribeScdnDomainBpsDataRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("scdn", "2017-11-15", "DescribeScdnDomainBpsData", "scdn", "openAPI");
		$this->setMethod("POST");
	}
