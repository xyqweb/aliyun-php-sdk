...
class DescribeScdnDomainTrafficDataRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("scdn", "2017-11-15", "DescribeScdnDomainTrafficData", "scdn", "openAPI");
		$this->setMethod("POST");
	}
