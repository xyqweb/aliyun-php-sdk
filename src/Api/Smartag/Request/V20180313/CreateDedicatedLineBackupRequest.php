 ...
 * under the License.
 */
namespace Emmetltd\AliyunCore\Api\Smartag\Request\V20180313;

class CreateDedicatedLineBackupRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Smartag", "2018-03-13", "CreateDedicatedLineBackup", "smartag", "openAPI");
		$this->setMethod("POST");
	}
	...
	public function getVbrRegionId() {
