...
class DescribeSmartAccessGatewaysRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Smartag", "2018-03-13", "DescribeSmartAccessGateways", "smartag", "openAPI");
		$this->setMethod("POST");
	}
