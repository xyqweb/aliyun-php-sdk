...
class UpgradeSmartAccessGatewayRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Smartag", "2018-03-13", "UpgradeSmartAccessGateway", "smartag", "openAPI");
		$this->setMethod("POST");
	}
