...
class DescribeErrorLogRecordsRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("R-kvstore", "2015-01-01", "DescribeErrorLogRecords", "redisa", "openAPI");
		$this->setMethod("POST");
	}
