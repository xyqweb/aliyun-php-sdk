...
class GrantAccountPrivilegeRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("R-kvstore", "2015-01-01", "GrantAccountPrivilege", "redisa", "openAPI");
		$this->setMethod("POST");
	}
