...
class DeleteCommonBandwidthPackageRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Vpc", "2016-04-28", "DeleteCommonBandwidthPackage", "vpc", "openAPI");
		$this->setMethod("POST");
	}
