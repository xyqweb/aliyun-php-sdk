...
class RemoveCommonBandwidthPackageIpRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Vpc", "2016-04-28", "RemoveCommonBandwidthPackageIp", "vpc", "openAPI");
		$this->setMethod("POST");
	}
