...
class UnassociatePhysicalConnectionFromVirtualBorderRouterRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Vpc", "2016-04-28", "UnassociatePhysicalConnectionFromVirtualBorderRouter", "vpc", "openAPI");
		$this->setMethod("POST");
	}
