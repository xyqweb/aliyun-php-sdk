...
class DeleteGlobalAccelerationInstanceRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Vpc", "2016-04-28", "DeleteGlobalAccelerationInstance", "vpc", "openAPI");
		$this->setMethod("POST");
	}
