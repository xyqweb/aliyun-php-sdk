...
class ModifyRouterInterfaceSpecRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("Vpc", "2016-04-28", "ModifyRouterInterfaceSpec", "vpc", "openAPI");
		$this->setMethod("POST");
	}
