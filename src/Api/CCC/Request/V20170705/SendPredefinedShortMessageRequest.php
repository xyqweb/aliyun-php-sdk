...
class SendPredefinedShortMessageRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("CCC", "2017-07-05", "SendPredefinedShortMessage", "ccc", "openAPI");
		$this->setMethod("POST");
	}
