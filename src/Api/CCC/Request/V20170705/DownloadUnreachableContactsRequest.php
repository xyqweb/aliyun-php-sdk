...
class DownloadUnreachableContactsRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("CCC", "2017-07-05", "DownloadUnreachableContacts", "ccc", "openAPI");
		$this->setMethod("POST");
	}
