...
class StartJobRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("CCC", "2017-07-05", "StartJob", "ccc", "openAPI");
		$this->setMethod("POST");
	}
	...
	public function getSelfHostedCallCenter() {
