...
class DownloadOriginalStatisticsReportRequest extends \Emmetltd\AliyunCore\RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("CCC", "2017-07-05", "DownloadOriginalStatisticsReport", "ccc", "openAPI");
		$this->setMethod("POST");
	}
